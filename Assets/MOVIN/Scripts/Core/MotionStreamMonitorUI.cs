...
namespace MOVIN
{
    [AddComponentMenu("MOVIN/Motion Stream Monitor UI")]
    [DisallowMultipleComponent]
    public class MotionStreamMonitorUI : MonoBehaviour
    {
        ...
        private ThemeStyleSheet ResolveThemeStyleSheet()
        {
            ...
            if (!theme)
                Debug.LogWarning($"MotionStreamMonitorUI could not load '{DefaultThemeResourcePath}'. Assign a Theme Style Sheet to render the monitor panel.", this);
